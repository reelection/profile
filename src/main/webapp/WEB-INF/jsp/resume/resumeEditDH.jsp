    ...
    <script language="javascript">
      ...
      document.addEventListener('change',function(e){
        if(e.target && e.target.id== 'sexSelect'){
          ...
          document.getElementById("UserInfo_M_Gender").value = sexVelue;
        }
      });
    </script>
</head>
          ...
          <div class="form formProfile">
              <div class="row">
                      <div class="input is-label input-profile-name is-value">
                          ...
                          <input type="text" name="m_Name" id="UserInfo_M_Name" value="">
                      </div>
                      <div class="input is-label input-profile-birth is-value">
                          <label for="UserInfo_M_Born">생년월일<span class="star">*</span> : </label>
                          <input data-format-type="birth" data-max-date="2007.08.09" data-val="true" data-val-date="생년월일 필드는 날짜여야 합니다." id="UserInfo_M_Born" name="m_Born" placeholder="1991.03.01" type="text" value="">
                      </div>
              ...
              <input id="UserInfo_M_Gender" name="m_Gender" type="hidden" value="1">
          </div>
                  <div class="input input-profile-email is-label is-value">
                      <label for="UserInfo_M_Email">이메일 : </label>
                      <input type="email" name="m_Email" id="UserInfo_M_Email" data-format-type="email" value="kdh6335@naver.com" autocomplete="off" spellcheck="false">
              ...
              <div class="row">
                  <div class="input is-label input-profile-tel">
                      ...
                      <input type="text" name="m_Home_Phone" id="UserInfo_M_Home_Phone" placeholder="02-1234-1234" maxlength="30" autocomplete="off" data-format-type="tel">
                  </div>
